...
const SingleWorkshop: React.FC<SingleWorkshopProps> = ({ workshop }) => {
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3 mb-6">
      <div className="dark:bg-dark p-6 rounded-lg shadow-md">
        <Image
          src={workshop.image}
          alt={workshop.title}
          width={400}
        ...
        <p className=" mb-1">{workshop.description}</p>
        <div className="flex justify-between items-center">
           <span className=" font-bold">{workshop.date}</span>
        <span className="">{workshop.time}</span>
        </div>
